...
Items placed using the Entity Tool are consumed from your inventory and can be picked up again later, making the entire
workflow fully survival compatible.
